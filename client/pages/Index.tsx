        ...
        <div className="container py-24 md:py-32 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="mt-3 text-4xl md:text-6xl font-extrabold leading-tight tracking-tight">
              ...
              <span className="mt-2 block bg-gradient-to-r from-primary to-fuchsia-500 bg-clip-text text-transparent">
                Designing and building modern web experiences
              </span>
            </h1>
            <p className="mt-6 text-muted-foreground text-lg">
              I craft responsive, accessible interfaces with clean code,
              thoughtful motion, and a focus on performance.
            </p>
          ...
          <div className="relative">
            ...
            >
              <span className="text-4xl md:text-5xl font-bold bg-gradient-to-br from-primary to-fuchsia-500 bg-clip-text text-transparent">
                TP
              </span>
            </div>
      ...
      <section id="about" className="container py-20 md:py-28">
        <div className="grid md:grid-cols-3 gap-10 items-start">
          ...
          <div className="md:col-span-2 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              I’m Tran Mai Phuong, a developer who blends engineering and design
              to deliver polished digital products. My work centers on clarity,
              consistency, and delightful interactions.
            </p>
            <p>
              I care deeply about craft: design systems, accessibility,
              performance budgets, and code quality. I work across the stack
              with a focus on React, TypeScript, Node.js, and modern tooling.
            </p>
      ...
      <section id="projects" className="container py-20 md:py-28">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          {[
            ...
            <article
              key={p.title}
              className="group rounded-2xl border bg-card text-card-foreground overflow-hidden shadow-sm hover:shadow-md transition-shadow"
            >
